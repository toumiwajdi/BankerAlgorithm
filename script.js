    ...
    if (test) {
        if (testAllocation()) {
            ...
            if (!interblocage) {
                ...
                $("#div0").hide();
                html = "  <div style='padding: 15px;background-color: darkgreen;color:whitesmoke;'><h1 style='color:whitesmoke'>Pas d'interblocage</h1> <h5 style='color:whitesmoke'>Séquence:</h5><table><tr>";
                ...
                html = "  <div style='padding: 15px;background-color: crimson;color:whitesmoke;'><h1>Interblocage !</h1><h5>Séquence imcompléte !</h5></div>";
                $("#div5").append(html);
